...
# ************************************************************************
# File:    He_atom_rhf_imesh.py
# Purpose: Solve the ground-state of He atom in restricted Hartree-Fock model with imported mesh, including energy correction step
...
mesh=Mesh("../1.beatom_hf/mesh.40.40.9.xml.gz")
